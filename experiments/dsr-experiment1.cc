...
main (int argc, char *argv[])
{
  ...
  uint32_t budget = 30;
  InstallDGPacketSend (nodes.Get (2), sinkAddress, 0.1, 0.6, Packetsize, NPacket, budget, "2Mbps", true);
  InstallDGPacketSend (nodes.Get (2), sinkAddress, 0.6, 1.0, Packetsize, NPacket, budget, "2.5Mbps", true);
  InstallDGPacketSend (nodes.Get (2), sinkAddress, 1.0, 1.6, Packetsize, NPacket, budget, "3Mbps", true);
  InstallDGPacketSend (nodes.Get (2), sinkAddress, 1.6, 2.0, Packetsize, NPacket, budget, "3.5Mbps", true);
