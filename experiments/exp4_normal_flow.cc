...
main (int argc, char *argv[])
{
  ...
  tch.AddChildQueueDisc (handle, cid[0], "ns3::FifoQueueDisc", "MaxSize", StringValue("35p"));
  tch.AddChildQueueDisc (handle, cid[1], "ns3::FifoQueueDisc", "MaxSize", StringValue("120p"));
